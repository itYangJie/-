     ...
     , OnItemSelectedListener, IpcamClientInterface,CallBackMessageInterface
{
	...
	private void InitParams() {
		didEdit.setText(settingManager.getCameraEquipmentId());
		pwdEdit.setText(settingManager.getCameraPassword());
...
*/
	...
	private void done() {
		...
		//保存设备ID，密码，下次进入直接显示
		settingManager.setCameraEquipmentId(strDID);
		settingManager.setCameraPassword(strPwd);
